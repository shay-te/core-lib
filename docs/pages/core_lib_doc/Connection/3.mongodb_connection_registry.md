...
> **Where it fits:** Connection layer for MongoDB. Create it in `CoreLib.__init__`, pass it to MongoDB `DataAccess` classes, and keep the native `MongoClient` lifecycle out of your services.
