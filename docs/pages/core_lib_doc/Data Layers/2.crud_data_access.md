...
> **Where it fits:** DataAccess layer. Use these base classes when a SQLAlchemy entity needs normal CRUD methods and your `Service` should not write queries directly.
