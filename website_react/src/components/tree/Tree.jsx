...
import { setFields, deleteTreeBranch, addNewEntry, toggleCollapseExpand } from "../slices/treeSlice";
		...
		return (
			<div className="tree-root">
				<div className="tree">
					...
					<button className="export-button" onClick={() => exportYaml()}>Export</button>
				</div>
			</div>
		);
	};
